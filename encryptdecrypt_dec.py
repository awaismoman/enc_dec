...
b = '\x1b[1;34m'
bm = '\x1b[96m'
about = ('\n                {}Creator           : {}Awais khan\n                {}About             : {}Encrypt And Decrypt Tool\n                {}Version           : {}1.0 (beta)\n                {}Special thanks to : {}Allah SWT and YOU\n                {}Code name         : {}Tytyd:v\n                {}Team              : {}UNDERGROUND SCIENCE\n                {}E-mail            : {}923173725015\n                {}Github            : {}github.com/Awaismoman\n                {}yt          : {}t.me/technical awais\n                {}Facebook          : {}Upss (Fb gua masih kena cp:v)\n                {}Date              : {}16.49 02-02-2022\n                {}Region            : {}kpk,Karachi, pakistan').format(p, k, p, k, p, k, p, k, p, k, p, k, p, k, p, k, p, k, p, k, p, k, p, k, p, k)

def chat():
    load('Silahkan Tunggu Sebentar---')
    os.system('xdg-open ,https://www.whatsapp.com/business/+923173725015?')
...
def menu():
    ...
    if fuck == '1' or fuck == '01':
        ...
        try:
            sp.check_output([
             'am', 'start',
             'https://www.whatsapp.com/business/+923173725015text=Report : ' + chat + ''])
        except:
